defmodule Game.Board.Map do
  ...
  def get() do
    %{
      ...
      {0, 2} => "rock", {1, 2} => "grass", {2, 2} => "grass", {3, 2} => "grass_flowers", {4, 2} => "grass", {5, 2} => "grass", {6, 2} => "rock",
      {0, 3} => "rock", {1, 3} => "grass_flowers", {2, 3} => "grass", {3, 3} => "grass", {4, 3} => "grass", {5, 3} => "grass", {6, 3} => "rock", 
      {0, 4} => "rock", {1, 4} => "grass", {2, 4} => "grass", {3, 4} => "grass", {4, 4} => "grass_flowers", {5, 4} => "grass", {6, 4} => "rock",
